...
class Dispatcher(ABC):
    """
    Abstract class that the bot will use for retrieving price data and buy/sell
    orders in the way that child classes decide to implement this class.
    Deriving classes could, for example, be used to create dispatchers for
    different exchanges, as well as for testing strategies.
    """
